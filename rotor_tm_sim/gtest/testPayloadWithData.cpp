...
TEST_F(rotorTMPayloadTestWithData, checkDynamicsIntWithPythonData) {
  ...
  ptr_payload->get_spdlog_logger()->info("Py_mass = {}", test_data.mass);
  // ptr_payload->get_spdlog_logger()->info("Cxx_mass = {}", ptr_payload->mass());
  ...
  ptr_payload->get_spdlog_logger()->info("Py_gravity = {}", test_data.grav);
  // ptr_payload->get_spdlog_logger()->info("Cxx_gravity = {}",Utils::gravity);
